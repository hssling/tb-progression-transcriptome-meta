...
def manuscript_text(data: AdvancedData) -> dict[str, list[str] | str]:
    ...
    conclusion = (
        ...
        "analysis, Bayesian gene synthesis, pathway modeling, and correlation structure analysis. The current "
...
def build_highlights() -> Path:
    ...
    for line in [
        ...
        "Latent factors and pathway modeling pointed to coordinated host-response programs.",
